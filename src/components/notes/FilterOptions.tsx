...
import { ArrowUpDown, BookmarkedIcon, ClockIcon, FilesIcon, HashIcon, FileQuestionIcon } from 'lucide-react';
...
const FilterOptions: React.FC<FilterOptionsProps> = ({ viewMode, setViewMode }) => {
  const options = [
    ...
    { id: 'favorites', label: 'Favorites', icon: <BookmarkedIcon size={14} /> },
